...
![](metadata.png){fig-alt="Preview of metadata standardization tool"}
...
![](post-processing.png){fig-alt="Preview of post-processing tool"}
...
![](plots.png){fig-alt="Example of iSEE plots"}

## Download

A working version of e-OMIX can be downloaded [here](https://github.com/e-OMIX/e-OMIX).
